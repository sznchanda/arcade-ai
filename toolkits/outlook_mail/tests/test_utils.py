...
from arcade_outlook_mail._utils import _create_filter_expression
from arcade_outlook_mail.enums import EmailFilterProperty, FilterOperator
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "receivedDateTime ge 1900-01-01T00:00:00Z and conversationId eq '12345askdfjh=wef67890'",
        ),
        (
            EmailFilterProperty.CONVERSATION_ID,
        ...
        (
            ...
            FilterOperator.EQUAL,
            "a@ex.com",
            "receivedDateTime ge 1900-01-01T00:00:00Z and sender/emailAddress/address eq 'a@ex.com'",
        ),
        (
            EmailFilterProperty.SENDER,
            FilterOperator.CONTAINS,
            "joe",
            "receivedDateTime ge 1900-01-01T00:00:00Z and contains(sender/emailAddress/address, 'joe')",
        ),
    ],
)
