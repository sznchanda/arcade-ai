...
from arcade_outlook_calendar import get_event
from evals.additional_messages import get_event_additional_messages
...
catalog = ToolCatalog()
catalog.add_tool(get_event, "OutlookCalendar")
    ...
    suite.add_case(
        ...
        expected_tool_calls=[
            ExpectedToolCall(
                func=get_event,
                args={
                    "event_id": "AAMkADAwATM0MDAAMi04Y2Y1LTQ3MTEALTAwAi0wMAoARgAAAyXxSd3UxTpCkDpGouEg0JMBAFuxokOLZRtDncM4",
                },
            )
        ],
        critics=[
