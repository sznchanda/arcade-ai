...
class TestMatterTools:
    ...
    @pytest.mark.asyncio
    async def test_get_matter_activities_success(self, mock_tool_context, sample_activities_response):
...
class TestMatterEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_matter_with_multiple_participants(self, mock_tool_context, sample_matter_with_participants):
