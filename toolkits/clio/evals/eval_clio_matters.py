...
def eval_clio_matter_edge_cases() -> EvalSuite:
    ...
    suite.add_case(
        ...
        expected_tool_calls=[
            ExpectedToolCall(
                func=arcade_clio.get_matter,
                args={"matter_id": 67890}
            ),
            ExpectedToolCall(
                func=arcade_clio.get_matter,
                args={"matter_id": 67891}
            ),
            ExpectedToolCall(
                func=arcade_clio.get_matter,
                args={"matter_id": 67892}
            )
        ]
    )
